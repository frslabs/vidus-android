# VIDUS ANDROID SDK
![version](https://img.shields.io/badge/version-v3.2.7-blue)
...
| --------------------------------------------| ------------------------------------------------- | --------------- | ----------------------- |
| [Vidus SDK](#vidus-sdk) (Required)                                     | com.frslabs.android.sdk:vidus                   | ![version](https://img.shields.io/badge/version-v3.2.6-blue)    | 550 KB     |
