# VIDUS ANDROID SDK
![version](https://img.shields.io/badge/version-v3.2.8-blue)
...
| --------------------------------------------| ------------------------------------------------- | --------------- | ----------------------- |
| [Vidus SDK](#vidus-sdk) (Required)                                     | com.frslabs.android.sdk:vidus                   | ![version](https://img.shields.io/badge/version-v3.2.8-blue)    | 550 KB     |
